...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Chương_4/results/har_gru/01_a_class_distribution_bar.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{Chương_4/results/har_gru/01_b_class_distribution_pie.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Chương_4/results/har_gru/04_a_confusion_matrix.png}
